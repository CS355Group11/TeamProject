...
import edu.cs355.group11.service.Vendor;
...
public class FileUtilities {
	...
	public static TransactionSet readFile(String fileInputName) {
		...
		try {
			...
			errorLogs.getErrorMsgs().add("File Not Found Error: Unable to open file '" + fileInputName + "'");
			System.out.println("Unable to open file '" + fileInputName + "'");
		} catch (IOException ex) {
			errorLogs.getErrorMsgs().add("Error reading file '" + fileInputName + "'");
